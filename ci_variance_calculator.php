...
Version: 1.0.0
Author: Variance Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Variance Calculator by www.calculator.io";

function display_calcio_ci_variance_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_variance_calculator', 'display_calcio_ci_variance_calculator' );